(() => {
  ...
  function validateEditor(name,data,action) {
    ...
    if(name==='blog'&&!isDraft&&!String(data.content||'').trim())return'Yazının metnini ekleyin.';
