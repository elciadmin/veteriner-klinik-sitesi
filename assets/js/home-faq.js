(() => {
  ...
  Promise.all([
    ...
    const all = [...merged.values()].filter(item => item && item.published !== false && item.q && item.a);
    ...
    host.innerHTML = '<p class="home-faq-status">Sorular şu anda yüklenemedi. <a href="/sss.html">SSS sayfasını açın.</a></p>';
  });
})();
